...
function ProjectPoster({ src }: ProjectVideoProps) {
  return (
    <MorphingDialog
      transition={{
        type: 'spring',
      ...
      >
        <div className="flex-1">
          <p className="text-zinc-600 dark:text-zinc-400">
            Passionate about distributed, high-performance systems.
            Dedicated to designing simple solutions for complex real-world problems.
          </p>
        </div>
      </motion.section>
          ...
          {PROJECTS.map((project) => (
            <div key={project.name} className="space-y-2">
              <div className="relative rounded-2xl bg-zinc-50/40 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950/40 dark:ring-zinc-800/50">
                <ProjectPoster src={project.image_url} />
              </div>
              <div className="px-1">
                <a
